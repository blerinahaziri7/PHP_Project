              ...
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Shëno email-in</label>
                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Shëno email-in">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputQuestion">Shëno pyetjen</label>
                    <input type="text" name="Sheno pyetjen" class="form-control" id="exampleInputQuestion" placeholder="Shëno pyetjen">
                  </div>
                </div>
                <!-- /.card-body -->
