                    ...
                    <a class="d-block w-100" data-toggle="collapse" href="#collapseOne">
                        <div class="card-header">
                            <h4 class="card-title w-100">
                                1. Si mund te shtoj nje lende?
                            </h4>
                        </div>
                    </a>
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                        <div class="card-body">
                            Shko tek lendet dhe kliko shto nje lende te re.
                        </div>
                    </div>
                </div>
                <div class="card card-primary card-outline">
                    <a class="d-block w-100" data-toggle="collapse" href="#collapseTwo">
                        <div class="card-header">
                            <h4 class="card-title w-100">
                                2.Si te bej dorezimin e detyres?
                            </h4>
                        </div>
                    </a>
                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                           Shko tek dorezimi i detyres, zgjedh file-in dhe bej submit.
                        </div>
                    </div>
                </div>
                <div class="card card-primary card-outline">
                    <a class="d-block w-100" data-toggle="collapse" href="#collapseThree">
                        <div class="card-header">
                            <h4 class="card-title w-100">
                                3. Ku duhet te shoh vleresimin e projektit?
                            </h4>
                        </div>
                    </a>
                    <div id="collapseThree" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            Shko tek dorezimet e detyres dhe shih vleresimet per te gjitha detyrat e tua.
                        </div>
                    </div>
                </div>
        <div class="row">
            <div class="col-12 mt-3 text-center">
                <p class="lead">
                    <a href="contact-us.php">Na kontaktoni</a>,
                    nese nuk keni gjetur pergjigjen e duhur ose keni nje pyetje tjeter?<br />
                </p>
            </div>
        </div>
    </section>
